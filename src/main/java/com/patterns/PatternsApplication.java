...
import com.patterns.behavioural.chain_of_responsibility.*;
import com.patterns.behavioural.observer.Observer;
import com.patterns.behavioural.observer.PhoneDisplay;
import com.patterns.behavioural.observer.TVDisplay;
import com.patterns.behavioural.observer.WeatherStation;
import com.patterns.behavioural.strategy.BubbleSortStrategy;
import com.patterns.behavioural.strategy.QuickSortStrategy;
import com.patterns.behavioural.strategy.SortingContext;
import com.patterns.creational.abstract_factory.*;
import com.patterns.creational.builder.Person;
import com.patterns.creational.factory_method.Client;
import com.patterns.creational.factory_method.FourWheelerFactory;
import com.patterns.creational.factory_method.TwoWheelerFactory;
import com.patterns.creational.prototype.Circle;
import com.patterns.creational.prototype.Shape;
import com.patterns.creational.prototype.ShapeClient;
import com.patterns.creational.singleton.MySingleton;
import com.patterns.structural.adapter.Printer;
import com.patterns.structural.adapter.PrinterAdapter;
import com.patterns.structural.bridge.DrawApiA;
import com.patterns.structural.bridge.DrawApiB;
import com.patterns.structural.decorator.EmailNotifier;
import com.patterns.structural.decorator.HeaderNotifierDecorator;
import com.patterns.structural.decorator.LoggingNotifierDecorator;
import com.patterns.structural.decorator.Notifier;
import com.patterns.structural.proxy.Image;
import com.patterns.structural.proxy.ImageProxy;
...
//		System.out.println("Cost: $" + sugarMilkCoffee.getCost());
		...
		System.out.println("\n\n---------------- bridge ----------------");
		com.patterns.structural.bridge.Shape redCircle = new com.patterns.structural.bridge.Circle(0, 0, 20, new DrawApiA());
		com.patterns.structural.bridge.Shape redSquare = new com.patterns.structural.bridge.Square(200, 200, 25, new DrawApiA());
		com.patterns.structural.bridge.Shape blueCircle = new com.patterns.structural.bridge.Circle(10, 10, 30, new DrawApiB());
		com.patterns.structural.bridge.Shape blueSquare = new com.patterns.structural.bridge.Square(210, 210, 35, new DrawApiB());
		redCircle.draw();
		redSquare.draw();
		blueCircle.draw();
		blueSquare.draw();
